...
struct ExtendedMessages {
  ...
  using MessageVariant =
      std::variant<ExtendedIdMessage1, ExtendedIdMessage2, ExtendedIdMessage3,
                   ExtendedIdMessage4, ExtendedIdMessage5, ExtendedIdMessage6,
                   ExtendedIdMessage7, ExtendedIdMessage8, ExtendedIdMessage9,
                   ExtendedIdMessage10, LargePayloadMessage1, LargePayloadMessage2,
  ...
  static ExtendedIdMessage1 create_ext_id_1() {
    ExtendedIdMessage1 msg{};
  ...
  static ExtendedIdMessage3 create_ext_id_3() {
    ExtendedIdMessage3 msg{};
  ...
  static ExtendedIdMessage4 create_ext_id_4() {
    ExtendedIdMessage4 msg{};
    msg.event_id = 999999;
    msg.event_type = 42;
  ...
  static ExtendedIdMessage5 create_ext_id_5() {
    ExtendedIdMessage5 msg{};
  ...
  static ExtendedIdMessage6 create_ext_id_6() {
    ExtendedIdMessage6 msg{};
  ...
  static ExtendedIdMessage7 create_ext_id_7() {
    ExtendedIdMessage7 msg{};
  ...
  static ExtendedIdMessage8 create_ext_id_8() {
    ExtendedIdMessage8 msg{};
    msg.level = 255;
    msg.offset = -32768;
