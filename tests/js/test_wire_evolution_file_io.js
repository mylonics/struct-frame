/**
 * Cross-language x cross-version wire-evolution file I/O (JavaScript).
...
const { BaseExtensionMessage: V1BaseExtensionMessage } = require('../generated/js/wire-evolution-v1.structframe');
const { BaseExtensionMessage: V2BaseExtensionMessage } = require('../generated/js/wire-evolution-v2.structframe');

const HEADER = 0x1234;
const SEQ = 42;
const CRC_SEED = 0xdeadbeef;

function doEncode(version, path) {
  let buf;
  if (version === 'v1') {
...
function doDecode(version, path) {
