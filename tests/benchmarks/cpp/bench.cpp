// Tier D shared-schema benchmark for C++ (mirrors tests/benchmarks/c/bench.c).
// Self-contained: emits tests/benchmarks/results/cpp.json matching schema.json.
...
int main(int argc, char** argv) {
  int iters = getenv("BENCH_ITERATIONS")
                  ...
                  : 50000;
  const char* out = "tests/benchmarks/results/cpp.json";
