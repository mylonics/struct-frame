...
| Language | Sync/Async | Transports | Observer Pattern |
|----------|------------|------------|------------------|
| **TypeScript/JavaScript** | Async (Promise-based) | UDP, TCP, WebSocket, Serial | Callback-based |
| **Python** | Both Sync & Async | UDP, TCP, WebSocket, Serial | Callback-based |
| **C++** | Sync (poll-based) | UDP*, TCP*, WebSocket*, Serial | Observer/Subscriber |
| **C#** | Async (Task-based) | UDP, TCP, WebSocket*, Serial | Event-based |

*UDP, TCP, WebSocket transports in C++ require ASIO and Simple-WebSocket-Server libraries. See [C++ SDK documentation](cpp-sdk.md) for details.
