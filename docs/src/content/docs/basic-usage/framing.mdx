---
title: Framing
description: Wrap messages with headers and checksums for reliable communication over serial links, network sockets, or any byte stream.
---
...
For more details, see [Framing Details](/basic-usage/framing-details/).
