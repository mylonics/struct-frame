...
'''
    ...
    def generate_main_header(formats):
        ...
        yield 'using ProfileStandard = BasicDefaultParser;  // General Serial / UART\n'
        yield 'using ProfileSensor = TinyMinimalParser;     // Low-Bandwidth / Radio\n'
        yield '// using ProfileIPC = NoneMinimalParser;        // Trusted / Board-to-Board (NoneMinimal not generated for C++)\n'
        yield 'using ProfileBulk = BasicExtendedParser;     // Firmware / File Transfer\n'
        yield 'using ProfileNetwork = BasicExtendedMultiSystemStreamParser;  // Multi-Node Mesh / Swarm\n\n'
        yield '}  // namespace FrameParsers\n'

    @staticmethod
    def generate_header(formats):
        """Generate the complete frame parser header file (single file mode)"""
...
'''
    ...
    def generate_format(fmt):
        ...
        yield f'                // Not enough bytes for a complete frame - don't consume anything\n'
        yield f'                if (bytes_consumed) *bytes_consumed = 0;\n'
        ...
        if fmt.has_crc:
            ...
            yield f'                // Can't parse without message length callback - don't consume\n'
            yield f'                if (bytes_consumed) *bytes_consumed = 0;\n'
            yield f'                return FrameMsgInfo();\n'
            yield f'            }}\n\n'
            ...
            yield f'                // Not enough data for complete frame - don't consume\n'
            yield f'                if (bytes_consumed) *bytes_consumed = 0;\n'
            yield f'                return FrameMsgInfo();\n'
            yield f'            }}\n\n'
