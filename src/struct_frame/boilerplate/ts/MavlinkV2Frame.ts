...
export class MavlinkV2Frame {
        ...
        switch (this.state) {
            ...
            case MavlinkV2FrameParserState.GETTING_PAYLOAD:
                ...
                if (this.buffer.length >= this.packet_size) {
                    ...
                    const validationResult = validate_payload_with_crc(this.buffer, MavlinkV2Frame.HEADER_SIZE, 1, 1);
    ...
    static validate_packet(buffer: Uint8Array | number[]): FrameMsgInfo {
        ...
        // Use shared payload validation with CRC
        return validate_payload_with_crc(buffer, MavlinkV2Frame.HEADER_SIZE, 1, 1);
    }
}
