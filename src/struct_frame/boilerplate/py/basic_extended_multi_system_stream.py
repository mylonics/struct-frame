...
class BasicExtendedMultiSystemStream:
    ...
    def validate_packet(buffer: Union[bytes, List[int]]) -> FrameMsgInfo:
        ...
        msg_length = len(buffer) - BasicExtendedMultiSystemStream.OVERHEAD
        ...
        if ck[0] == buffer[-2] and ck[1] == buffer[-1]:
            ...
            result.msg_len = msg_length
            result.msg_data = bytes(buffer[BasicExtendedMultiSystemStream.HEADER_SIZE:len(buffer) - BasicExtendedMultiSystemStream.FOOTER_SIZE])
