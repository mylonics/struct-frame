...
# Generated by 0.0.1 at Sun Nov 30 16:55:10 2025.
...
class BasicFrame:
    ...
    def parse_byte(self, byte: int) -> FrameMsgInfo:
        ...
        elif self.state == BasicFrameParserState.LOOKING_FOR_START2:
...
class BasicFrameWithLen:
    ...
    def parse_byte(self, byte: int) -> FrameMsgInfo:
        ...
        elif self.state == BasicFrameWithLenParserState.LOOKING_FOR_START2:
            if byte == self.START_BYTE2:
                self.buffer.append(byte)
...
class BasicFrameWithLenNoCrc:
    ...
    def parse_byte(self, byte: int) -> FrameMsgInfo:
        ...
        elif self.state == BasicFrameWithLenNoCrcParserState.LOOKING_FOR_START2:
            if byte == self.START_BYTE2:
                self.buffer.append(byte)
...
class BasicFrameWithLen16:
    ...
    def parse_byte(self, byte: int) -> FrameMsgInfo:
        ...
        elif self.state == BasicFrameWithLen16ParserState.LOOKING_FOR_START2:
            if byte == self.START_BYTE2:
                self.buffer.append(byte)
...
class BasicFrameWithSysComp:
    ...
    def parse_byte(self, byte: int) -> FrameMsgInfo:
        ...
        elif self.state == BasicFrameWithSysCompParserState.LOOKING_FOR_START2:
            if byte == self.START_BYTE2:
                self.buffer.append(byte)
