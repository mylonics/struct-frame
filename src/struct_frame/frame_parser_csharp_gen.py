...
class FrameParserCSharpGen:
    ...
    def generate_main(formats):
        ...
        yield '        public static BasicDefault ProfileStandard() => new BasicDefault();\n'
        yield '        /// <summary>Low-Bandwidth / Radio</summary>\n'
        yield '        public static TinyMinimal ProfileSensor() => new TinyMinimal();\n'
        yield '        // ProfileIPC (NoneMinimal) not generated for C#\n'
        yield '        /// <summary>Firmware / File Transfer</summary>\n'
        yield '        public static BasicExtended ProfileBulk() => new BasicExtended();\n'
        yield '        /// <summary>Multi-Node Mesh / Swarm</summary>\n'
        yield '        public static BasicExtendedMultiSystemStream ProfileNetwork() => new BasicExtendedMultiSystemStream();\n'
        yield '    }\n'
